                                ...
                                <div class="blog-post-media swiper-container slider-nav-style-1 small-nav">
                                    <div class="blog-gallery swiper-wrapper">
                                        <div class="gallery-item swiper-slide">
                                            <a href="#"><img src="{{url('user')}}/images/blog-image/3.jpg" alt="blog" /></a>
                                        </div>
                                        <div class="gallery-item swiper-slide">
                                            <a href="#"><img src="{{url('user')}}/images/blog-image/2.jpg" alt="blog" /></a>
                                        </div>
                                        <div class="gallery-item swiper-slide">
                                            <a href="#"><img src="{{url('user')}}/images/blog-image/1.jpg" alt="blog" /></a>
                                        </div>
                                    </div>
                                    <!-- Add Arrows -->
                                        ...
                                        <a class="venobox venoboxvid video-icon overflow-hidden vbox-item"
                                           ...
                                           href="https://youtu.be/Hx64uvCA_zQ">
                                            <img class="img-responsive w-100 thumb-image"
                                                 src="{{url('user')}}/images/blog-image/1.jpg" alt="">
                                            <img class="icon" src="{{url('user')}}/images/icons/icon-youtube-play.png" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="blog-text">
                            ...
                            <div class="recent-post-widget">
                                <div class="recent-single-post d-flex">
                                    <div class="thumb-side">
                                        <a href="blog-single-left-sidebar.php"><img
                                                src="{{url('user')}}/images/blog-image/1.jpg" alt="" /></a>
                                    </div>
                                    <div class="media-side">
                                        <span class="date"> <i class="fa fa-calendar"></i> 24 Aug, 2021</span>
                                        <h5><a href="blog-single-left-sidebar.php">Lorem ipsum dolorlo
                                                conse tetur adipi.</a>
                                        </h5>
                                    </div>
                                </div>
                                <div class="recent-single-post d-flex">
                                    <div class="thumb-side">
                                        <a href="blog-single-left-sidebar.php"><img
                                                src="{{url('user')}}/images/blog-image/2.jpg" alt="" /></a>
                                    </div>
                                    <div class="media-side">
                                        <span class="date"> <i class="fa fa-calendar"></i> 24 Aug, 2021</span>
                                        <h5><a href="blog-single-left-sidebar.php">Lorem ipsum dolorlo
                                ...
                                <div class="recent-single-post d-flex">
                                    <div class="thumb-side">
                                        <a href="blog-single-left-sidebar.php"><img
                                                src="{{url('user')}}/images/blog-image/3.jpg" alt="" /></a>
                                    </div>
                                    <div class="media-side">
                                        <span class="date"> <i class="fa fa-calendar"></i> 24 Aug, 2021</span>
                                        <h5><a href="blog-single-left-sidebar.php">Lorem ipsum dolorlo
