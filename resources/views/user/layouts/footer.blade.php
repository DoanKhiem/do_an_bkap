                    ...
                    <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                        <div class="single-wedge">
                            <div class="footer-logo">
                                <a href="index.php"><img src="{{url('user')}}/images/logo/logo-white.png" alt=""></a>
                            </div>
                            ...
                            <div class="footer-links">
                                <div class="footer-row">
                                    <ul class="align-items-center">
                                        ...
                                        <li class="li"><a class="single-link" href="about.php">About</a></li>
                    ...
                    <div class="col-md-3 col-lg-2 col-sm-6 mb-lm-30px pl-lg-50px">
                        <div class="single-wedge">
                            ...
                            <div class="footer-links">
                                <div class="footer-row">
                                    <ul class="align-items-center">
                                        <li class="li"><a class="single-link" href="about.php"> About </a>
                                        </li>
                                        <li class="li"><a class="single-link" href="blog-grid.php">Blog</a></li>
                    ...
                    <div class="col-md-3 col-lg-2 col-sm-6 mb-lm-30px pl-lg-50px">
                        <div class="single-wedge">
                            ...
                            <div class="footer-links">
                                <div class="footer-row">
                                    <ul class="align-items-center">
                                        <li class="li"><a class="single-link" href="index.php">Jesco</a>
                                        </li>
                                        ...
                                        <li class="li"><a class="single-link" href="login.php">Log in</a></li>
                    ...
                    <div class="col-md-4 col-lg-3 col-sm-6">
                        <div class="single-wedge">
                            ...
                            <div class="footer-links">
                                ...
                                <img src="{{url('user')}}/images/icons/payment.png" alt="" class="payment-img img-fulid">
