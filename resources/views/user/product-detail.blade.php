                    ...
                    <div class="single-product-slider swiper-container slider-nav-style-1 small-nav mb-30px">
                        <div class="single-product-slider-wrapper swiper-wrapper">
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="{{url('user')}}/images/product-image/1.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="{{url('user')}}/images/product-image/2.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="{{url('user')}}/images/product-image/3.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="{{url('user')}}/images/product-image/4.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="{{url('user')}}/images/product-image/5.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="{{url('user')}}/images/product-image/6.jpg" alt="slider-item-img"></a>
                            </div>
                            <div class="single-product-slider-item swiper-slide">
                                <a href="#"><img class="img-responsive" src="{{url('user')}}/images/product-image/7.jpg" alt="slider-item-img"></a>
                            </div>
                        </div>
                        <!-- Add Arrows -->
                    ...
                    <div class="product-details-content quickview-content">
                        ...
                        <div class="pro-details-quality">
                            ...
                            <div class="pro-details-compare-wishlist pro-details-compare">
                                <a href="compare.php"><i class="pe-7s-refresh-2"></i></a>
                            </div>
                        </div>
                                ...
                                <div class="review-wrapper">
                                    <div class="single-review">
                                        <div class="review-img">
                                            <img src="{{url('user')}}/images/review-image/1.png" alt="" />
                                        </div>
                                    ...
                                    <div class="single-review child-review">
                                        <div class="review-img">
                                            <img src="{{url('user')}}/images/review-image/2.png" alt="" />
                                        </div>
                                        <div class="review-content">
                                            <div class="review-top-wrap">
                                                <div class="review-left">
