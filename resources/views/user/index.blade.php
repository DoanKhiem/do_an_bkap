                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 align-self-center sm-center-view">
                            <div class="hero-slide-content slider-animated-1">
                                ...
                                <a href="shop-left-sidebar.php" class="btn btn-lg btn-primary btn-hover-dark"> Shop Now <i
                        ...
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{url('user')}}/images/slider-image/slider-1.png" alt="" />
                                </div>
                                <div class="display-wrapper">
                                    <div class="content-side">
                                        <h4 class="title">Full Dress</h4>
                                        <span class="price">$21.00</span>
                                        <a href="shop-left-sidebar.php" class="shop-link">Shop Now</a>
                                    </div>
                                    <div class="image-side">
                                        <img src="{{url('user')}}/images/slider-image/display-image.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container align-self-center">
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="show-case">
                                <div class="hero-slide-image">
                                    <img src="{{url('user')}}/images/slider-image/slider-2.png" alt="" />
                                </div>
                                <div class="display-wrapper">
                                    <div class="content-side">
                                        <h4 class="title">Full Dress</h4>
                        ...
                        <div class="row">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.php" class="image">
                                            <img src="{{url('user')}}/images/product-image/1.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('user')}}/images/product-image/2.jpg"
                                                 alt="Product" />
                                        </a>
                                        <span class="badges">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="single-product.php">Women's Elizabeth Coat
                                            </a>
                                        </h5>
                                        <span class="price">
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.php" class="image">
                                            ...
                                            <img class="hover-image" src="{{url('user')}}/images/product-image/4.jpg"
                                                 alt="Product" />
                                        </a>
                                        <span class="badges">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.php" class="image">
                                            <img src="{{url('user')}}/images/product-image/5.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('user')}}/images/product-image/6.jpg"
                                                 alt="Product" />
                                        </a>
                                        <span class="badges">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="single-product.php">Women's Long Sleeve
                                                Shirts</a></h5>
                                        <span class="price">
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.php" class="image">
                                            <img src="{{url('user')}}/images/product-image/7.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('user')}}/images/product-image/8.jpg"
                                                 alt="Product" />
                                        </a>
                                        <span class="badges">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="single-product.php">Parrera Sunglasses -
                                                Lomashop</a></h5>
                                        <span class="price">
                                                <span class="new">$38.50</span>
                                            </span>
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-md-30px mb-lm-30px"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.php" class="image">
                                            <img src="{{url('user')}}/images/product-image/2.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('user')}}/images/product-image/10.jpg"
                                                 alt="Product" />
                                        </a>
                                        <span class="badges">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="single-product.php">Cool Man Wearing
                                                Leather</a></h5>
                                        <span class="price">
                                                <span class="new">$38.50</span>
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6  mb-md-30px mb-lm-30px"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.php" class="image">
                                            <img src="{{url('user')}}/images/product-image/4.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('user')}}/images/product-image/12.jpg"
                                                 alt="Product" />
                                        </a>
                                        <span class="badges">
                                            </span>
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="single-product.php">Portrait Of A Young
                                                Stylish</a>
                                        </h5>
                                        <span class="price">
                                                <span class="new">$38.50</span>
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.php" class="image">
                                            <img src="{{url('user')}}/images/product-image/6.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('user')}}/images/product-image/14.jpg"
                                                 alt="Product" />
                                        </a>
                                        <span class="badges">
                                            </span>
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="single-product.php">Men's Fashion Leather
                                                Bag</a></h5>
                                        <span class="price">
                                                <span class="new">$30.50</span>
                                            </span>
                            ...
                            <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 " data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        <a href="single-product.php" class="image">
                                            <img src="{{url('user')}}/images/product-image/8.jpg" alt="Product" />
                                            <img class="hover-image" src="{{url('user')}}/images/product-image/16.jpg"
                                                 alt="Product" />
                                        </a>
                                        <span class="badges">
                                                <span class="new">Sale</span>
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title"><a href="single-product.php">Long sleeve knee
                                                length</a></h5>
                                        <span class="price">
                                                <span class="new">$38.50</span>
                                            </span>
    ...
    <div class="row m-0">
        <div class="col-12 col-lg-4 mb-md-30px mb-lm-30px">
            <div class="single-banner-2">
                <img src="{{url('user')}}/images/banner/4.jpg" alt="">
                <div class="item-disc">
        ...
        <div class="col-12 col-lg-4">
            <div class="single-banner-2">
                <img src="{{url('user')}}/images/banner/6.jpg" alt="">
                <div class="item-disc">
                            ...
                            <div class="new-product-wrapper swiper-wrapper">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.php" class="image">
                                                <img src="{{url('user')}}/images/product-image/9.jpg" alt="Product" />
                                                <img class="hover-image" src="{{url('user')}}/images/product-image/5.jpg"
                                                     alt="Product" />
                                            </a>
                                            <span class="badges">
                                                    <span class="sale">-10%</span>
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.php" class="image">
                                                <img src="{{url('user')}}/images/product-image/10.jpg" alt="Product" />
                                                <img class="hover-image" src="{{url('user')}}/images/product-image/2.jpg"
                                                     alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="new-product-item swiper-slide">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.php" class="image">
                                                <img src="{{url('user')}}/images/product-image/11.jpg" alt="Product" />
                                                <img class="hover-image" src="{{url('user')}}/images/product-image/11.jpg"
                                                     alt="Product" />
                                            </a>
                                            <span class="badges">
                                                    <span class="new">Sale</span>
            ...
            <div class="col-lg-4 mb-md-30px mb-lm-30px">
                <div class="single-blog ">
                    ...
                    <div class="blog-text">
                        ...
                        <h5 class="blog-heading"><a class="blog-heading-link"
                                                    href="blog-single-left-sidebar.php">It is a long established factoi
